...
class LichSuGG extends StatefulWidget {
  const LichSuGG({super.key, required this.title});

  final String title;

  @override
  State<LichSuGG> createState() => _LichSuState();
}

class _LichSuState extends State<LichSuGG> {
  @override
